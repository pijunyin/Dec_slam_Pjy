...
int main(){
    ...
    while(true){
        ...
        if(picseries.size()==2)
        {
            ...
            static_pic.copyTo ( img_show ( cv::Rect ( 0,0,static_pic.cols, static_pic.rows ) ) );
            pic2.copyTo ( img_show ( cv::Rect ( 0,static_pic.rows,static_pic.cols, static_pic.rows ) ) );
